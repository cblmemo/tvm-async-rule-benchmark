            ...
            for i_1_j_1_fused in T.thread_binding(1, thread="vthread.x"):
                for i_2_j_2_fused in T.thread_binding(96, thread="threadIdx.x"):
                    for i_3_init, j_3_init, i_4_init, j_4_init in T.grid(4, 1, 1, 4):
                        with T.block("Y_init"):
                            v_i = T.axis.spatial(512, i_0_j_0_fused // 4 * 16 + i_2_j_2_fused // 24 * 4 + i_3_init + i_4_init)
                            v_j = T.axis.spatial(384, i_0_j_0_fused % 4 * 96 + i_2_j_2_fused % 24 * 4 + j_3_init * 4 + j_4_init)
                            T.reads()
                        ...
                        for ax0_ax1_fused_0 in T.serial(6):
                            for ax0_ax1_fused_1 in T.thread_binding(96, thread="threadIdx.x"):
                                with T.block("A_shared"):
                                    T.where(ax0_ax1_fused_0 * 96 + ax0_ax1_fused_1 < 512)
                                    v0 = T.axis.spatial(512, i_0_j_0_fused // 4 * 16 + (ax0_ax1_fused_0 * 96 + ax0_ax1_fused_1) // 32)
                                    v1 = T.axis.spatial(256, k_0 * 32 + (ax0_ax1_fused_0 * 96 + ax0_ax1_fused_1) % 32)
                                    T.reads(A[v0, v1])
                            ...
                            for ax0_ax1_fused_1 in T.thread_binding(96, thread="threadIdx.x"):
                                for ax0_ax1_fused_2 in T.vectorized(4):
                                    with T.block("B_shared"):
                                        v0 = T.axis.spatial(256, k_0 * 32 + (ax0_ax1_fused_0 * 384 + ax0_ax1_fused_1 * 4 + ax0_ax1_fused_2) // 96)
                                        v1 = T.axis.spatial(384, i_0_j_0_fused % 4 * 96 + (ax0_ax1_fused_0 * 384 + ax0_ax1_fused_1 * 4 + ax0_ax1_fused_2) % 96)
                                        T.reads(B[v0, v1])
                                        T.writes(B_shared[v0, v1])
                                        B_shared[v0, v1] = B[v0, v1]
                        for k_1, i_3, j_3, k_2, i_4, j_4 in T.grid(16, 4, 1, 2, 1, 4):
                            with T.block("Y_update"):
                                v_i = T.axis.spatial(512, i_0_j_0_fused // 4 * 16 + i_2_j_2_fused // 24 * 4 + i_3 + i_4)
                                v_j = T.axis.spatial(384, i_0_j_0_fused % 4 * 96 + i_2_j_2_fused % 24 * 4 + j_3 * 4 + j_4)
                                v_k = T.axis.reduce(256, k_0 * 32 + k_1 * 2 + k_2)
                    ...
                    for ax0, ax1 in T.grid(4, 4):
                        with T.block("Y_local"):
                            v0 = T.axis.spatial(512, i_0_j_0_fused // 4 * 16 + i_2_j_2_fused // 24 * 4 + ax0)
                            v1 = T.axis.spatial(384, i_0_j_0_fused % 4 * 96 + i_2_j_2_fused % 24 * 4 + ax1)
