...
class Module:
    ...
    def main(inputs: T.Buffer[(1, 56, 56, 64), "float32"], weight: T.Buffer[(1, 1, 64, 64), "float32"], conv2d_nhwc: T.Buffer[(1, 56, 56, 64), "float32"]):
        ...
        weight_shared = T.alloc_buffer([1, 1, 64, 64], dtype="float32", scope="shared")
                ...
                for n_2_h_2_w_2_co_2_fused in T.thread_binding(128, thread="threadIdx.x"):
                    for n_3_init, h_3_init, w_3_init, co_3_init, n_4_init, h_4_init, w_4_init, co_4_init in T.grid(1, 7, 2, 1, 1, 1, 1, 2):
                        with T.block("conv2d_nhwc_init"):
                            ...
                            v_w = T.axis.spatial(56, w_4_init + n_0_h_0_w_0_co_0_fused % 14 // 2 * 8 + n_2_h_2_w_2_co_2_fused % 64 // 16 * 2 + w_3_init)
                    ...
                    for rh_0_rw_0_rc_0_fused in T.serial(4, annotations={"software_pipeline_async_stages":[0], "software_pipeline_order":[0, 1, 2], "software_pipeline_stage":[0, 0, 3]}):
                            ...
                            for ax0_ax1_ax2_ax3_fused_1 in T.thread_binding(128, thread="threadIdx.x"):
                                for ax0_ax1_ax2_ax3_fused_2 in T.vectorized(2):
                                    with T.block("PadInput_shared"):
                                        ...
                                        v1 = T.axis.spatial(56, n_0_h_0_w_0_co_0_fused // 14 * 14 + (ax0_ax1_ax2_ax3_fused_0 * 256 + ax0_ax1_ax2_ax3_fused_1 * 2 + ax0_ax1_ax2_ax3_fused_2) // 128)
                                        v2 = T.axis.spatial(56, n_0_h_0_w_0_co_0_fused % 14 // 2 * 8 + (ax0_ax1_ax2_ax3_fused_0 * 256 + ax0_ax1_ax2_ax3_fused_1 * 2 + ax0_ax1_ax2_ax3_fused_2) % 128 // 16)
                                        v3 = T.axis.spatial(64, rh_0_rw_0_rc_0_fused * 16 + (ax0_ax1_ax2_ax3_fused_0 * 256 + ax0_ax1_ax2_ax3_fused_1 * 2 + ax0_ax1_ax2_ax3_fused_2) % 16)
                            ...
                            for ax0_ax1_ax2_ax3_fused_1 in T.thread_binding(128, thread="threadIdx.x"):
                                for ax0_ax1_ax2_ax3_fused_2 in T.vectorized(4):
                                    with T.block("weight_shared"):
                                        ...
                                        v2 = T.axis.spatial(64, rh_0_rw_0_rc_0_fused * 16 + (ax0_ax1_ax2_ax3_fused_0 * 512 + ax0_ax1_ax2_ax3_fused_1 * 4 + ax0_ax1_ax2_ax3_fused_2) // 32)
                                        v3 = T.axis.spatial(64, n_0_h_0_w_0_co_0_fused % 2 * 32 + (ax0_ax1_ax2_ax3_fused_0 * 512 + ax0_ax1_ax2_ax3_fused_1 * 4 + ax0_ax1_ax2_ax3_fused_2) % 32)
                                        T.reads(weight[v0, v1, v2, v3])
                                        T.writes(weight_shared[v0, v1, v2, v3])
                                        weight_shared[v0, v1, v2, v3] = weight[v0, v1, v2, v3]
                        for rh_1, rw_1, rc_1, n_3, h_3, w_3, co_3, rh_2, rw_2, rc_2, n_4, h_4, w_4, co_4 in T.grid(1, 1, 4, 1, 7, 2, 1, 1, 1, 4, 1, 1, 1, 2):
                            with T.block("conv2d_nhwc_update"):
                                ...
                                v_w = T.axis.spatial(56, w_4 + n_0_h_0_w_0_co_0_fused % 14 // 2 * 8 + n_2_h_2_w_2_co_2_fused % 64 // 16 * 2 + w_3)
                                ...
                                v_rc = T.axis.reduce(64, rh_0_rw_0_rc_0_fused * 16 + rc_1 * 4 + rc_2)
                    ...
                    for ax0, ax1, ax2, ax3 in T.grid(1, 7, 2, 2):
                        with T.block("conv2d_nhwc_local"):
                            ...
                            v2 = T.axis.spatial(56, n_0_h_0_w_0_co_0_fused % 14 // 2 * 8 + n_2_h_2_w_2_co_2_fused % 64 // 16 * 2 + ax2)
