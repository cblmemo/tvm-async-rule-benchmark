...
def apply_trace(sch: tir.Schedule) -> None:
  ...
  v20, v21, v22, v23, v24 = sch.sample_perfect_tile(loop=l4, n=5, max_innermost_factor=64, decision=[7, 1, 8, 1, 1])
  l25, l26, l27, l28, l29 = sch.split(loop=l4, factors=[v20, v21, v22, v23, v24], preserve_unit_iters=True)
  v30, v31, v32, v33, v34 = sch.sample_perfect_tile(loop=l5, n=5, max_innermost_factor=64, decision=[7, 8, 1, 1, 1])
  l35, l36, l37, l38, l39 = sch.split(loop=l5, factors=[v30, v31, v32, v33, v34], preserve_unit_iters=True)
  v40, v41, v42, v43, v44 = sch.sample_perfect_tile(loop=l6, n=5, max_innermost_factor=64, decision=[4, 4, 16, 1, 1])
  ...
  v62, v63, v64 = sch.sample_perfect_tile(loop=l9, n=3, max_innermost_factor=64, decision=[4, 2, 8])
  ...
  l105, l106, l107 = sch.split(loop=l104, factors=[None, 128, 4], preserve_unit_iters=True)
  ...
  sch.annotate(block_or_loop=l153, ann_key="pragma_auto_unroll_max_step", ann_val=512)
  sch.annotate(block_or_loop=l153, ann_key="pragma_unroll_explicit", ann_val=1)
  b160 = sch.get_block(name="conv2d_nhwc", func_name="main")
