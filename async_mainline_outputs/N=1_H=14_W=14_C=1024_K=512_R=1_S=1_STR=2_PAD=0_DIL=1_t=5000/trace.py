...
def apply_trace(sch: tir.Schedule) -> None:
  ...
  v20, v21, v22, v23, v24 = sch.sample_perfect_tile(loop=l4, n=5, max_innermost_factor=64, decision=[1, 1, 1, 7, 1])
  ...
  v40, v41, v42, v43, v44 = sch.sample_perfect_tile(loop=l6, n=5, max_innermost_factor=64, decision=[16, 1, 32, 1, 1])
  ...
  sch.annotate(block_or_loop=l120, ann_key="pragma_auto_unroll_max_step", ann_val=16)
  ...
  sch.annotate(block_or_loop=l151, ann_key="pragma_auto_unroll_max_step", ann_val=16)
