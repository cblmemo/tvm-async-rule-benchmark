...
def apply_trace(sch: tir.Schedule) -> None:
  ...
  v5, v6, v7, v8, v9 = sch.sample_perfect_tile(loop=l2, n=5, max_innermost_factor=64, decision=[8, 4, 8, 1, 2])
  l10, l11, l12, l13, l14 = sch.split(loop=l2, factors=[v5, v6, v7, v8, v9], preserve_unit_iters=True)
  v15, v16, v17, v18, v19 = sch.sample_perfect_tile(loop=l3, n=5, max_innermost_factor=64, decision=[8, 1, 24, 4, 1])
  l20, l21, l22, l23, l24 = sch.split(loop=l3, factors=[v15, v16, v17, v18, v19], preserve_unit_iters=True)
  v25, v26, v27 = sch.sample_perfect_tile(loop=l4, n=3, max_innermost_factor=64, decision=[128, 3, 8])
  ...
  l60, l61, l62 = sch.split(loop=l59, factors=[None, 192, 4], preserve_unit_iters=True)
  ...
  l68, l69, l70 = sch.split(loop=l67, factors=[None, 192, 4], preserve_unit_iters=True)
